...
PLAYER_MOUSE_MOVE_DURATION: float = 1.0
...
# Время за загрузку экрана
PLAYER_SCREEN_WAIT_LOAD: float = 0.5
"""Даже если экран распознан как нужный, ждем это время, чтобы загрузились все элементы."""
